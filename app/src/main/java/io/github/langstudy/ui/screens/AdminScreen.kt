...
import io.github.langstudy.ui.components.SectionHeader
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            if (selectedLanguage.isNotBlank()) {
                ...
                item {
                    AddLinkSection(
                        onAdd = { name, url -> viewModel.addLink(name, url) },
                        isLoading = isLoading
                    )
                }
    ...
    Card(
        ...
        Column(
            ...
            AppButton(
                onClick = {
                    val formattedUrl =
                        if (url.startsWith("http://") || url.startsWith("https://")) url.trim() else "https://${url.trim()}"
